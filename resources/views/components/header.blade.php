...
<header class="main-header bg-light py-3 shadow-sm">
    <div class="container d-flex align-items-center justify-content-between">
        <!-- Logo -->
        <div class="logo">
            <a href="/" class="d-flex align-items-center">
                <img src="/img/logo.png" alt="Logo" class="me-2" style="height: 130px;">
        ...
        <nav class="navigation d-none d-md-flex gap-4">
            <a href="/" class="text-dark text-decoration-none">Homepage</a>
            <a href="/products" class="text-dark text-decoration-none">Product</a>
            <a href="/kit" class="text-dark text-decoration-none">Kit</a>
        </nav>
    ...
    <div class="nav-item dropdown">
        <a class="nav-link dropdown-toggle text-dark text-decoration-none" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
    ...
    <div class="collapse" id="navbarNav">
        <nav class="d-flex flex-column align-items-center mt-2">
            <a href="/" class="text-dark text-decoration-none py-2">Homepage</a>
            <a href="/kit" class="text-dark text-decoration-none py-2">Producten</a>
            <a href="/products" class="text-dark text-decoration-none py-2">Dashbord</a>
        </nav>
    </div>
</header>
